...
def get_batch_triplets(embeddings, current_batch_labels, triplet_loss_fn, mining_strat="BSHN"):
    """
    Calculate triplet loss for the current batch.
    """
    ...
    for i, positive_label in enumerate(current_batch_labels):
        ...
        return anchor_embedding, positive_embedding, negative_embedding, anchor_label, positive_label, negative_label, n_mbod_anchors, n_random, n_bshn, n_relaxed_bshn, n_bhn, batch_matches, dataset_matches
...
def train_model_mstb(
    ...
    for epoch in range(n_epochs):
        ...
        history['train_prof_map'].append(train_prof_class_map)
...
if __name__ == "__main__":
    ...
    try:
        ...
        wandb.init(project='MBOD-cl', name='mstb_v1-sin_m_01_05-b32',
            config={
                "batch_size": 32,
                "n_epochs": 1000,
                "learning_rate": 1e-4,
